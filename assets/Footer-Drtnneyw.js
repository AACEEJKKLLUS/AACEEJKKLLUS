const __vite__mapDeps = (
    ...
    d = m.f ||
        (m.f = [
            'assets/ImprintContent-pAiy-cV8.js',
            'assets/index-DdFBsOwr.js',
            'assets/index-BO9A5s5s.css',
            'assets/ImprintContent-EIPM9Rtp.css',
            'assets/ImprintLink-Br3mGSqv.js',
            'assets/ImprintLink-BLUAqoQ5.css',
        ])
) => i.map((i) => d[i])
import { r as e, j as t, _ as s } from './index-DdFBsOwr.js'
const o = e.lazy(() => s(() => import('./ImprintContent-pAiy-cV8.js'), __vite__mapDeps([0, 1, 2, 3]))),
    r = e.lazy(() => s(() => import('./ImprintLink-Br3mGSqv.js'), __vite__mapDeps([4, 1, 2, 5])))
function l() {
