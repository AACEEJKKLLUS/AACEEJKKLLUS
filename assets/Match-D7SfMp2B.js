const __vite__mapDeps = (
    ...
    d = m.f ||
        (m.f = [
            ...
            'assets/Notification-BfXAQ8S0.js',
            'assets/Notification-CL9gkfEi.css',
            'assets/MatchLinks-CaD3doB0.js',
            'assets/MatchLinks-BlZ3Ddsn.css',
        ])
) => i.map((i) => d[i])
import { j as e, r as n, _ as r } from './index-DW_7zADx.js'
const i = n.lazy(() => r(() => import('./Card-CcjruWR3.js'), __vite__mapDeps([0, 1, 2, 3]))),
    t = n.lazy(() => r(() => import('./Notification-BfXAQ8S0.js'), __vite__mapDeps([4, 1, 2, 5]))),
    a = n.lazy(() => r(() => import('./MatchLinks-CaD3doB0.js'), __vite__mapDeps([6, 1, 2, 7])))
function s() {
    return e.jsxs('div', {
        className: 'match',
        children: [
